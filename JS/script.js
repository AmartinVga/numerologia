document.getElementById("miFormu").addEventListener("submit", function(event) {
    ...
    resultado3.innerHTML = "Su numero de Mision de Vida es el " + resultadoFinal;
    ...
    finalDescripcion = document.getElementById('explicacion');
    finalDescripcion.innerHTML = mostrarDescripcion();
});
